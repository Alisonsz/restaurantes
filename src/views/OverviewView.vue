    ...
    <div class="performance container-report">
      <div class="report-titles">
        ...
        <div class="type-report">
          <button @click.prevent="changeReport('sales')" type="submit" class="btn" :class="{ 'report-active': reportSelected === 'sales' }">
            <span class="add-item add-inline icon-sale"></span> Vendas
          </button>
          <button @click.prevent="changeReport('requests')" type="submit" class="btn" :class="{ 'report-active': reportSelected === 'requests' }">
